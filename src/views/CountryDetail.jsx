...
class CountryDetail extends Component {
  ...
  loadCountryData() {
    ...
    const countryThatMatchesCountryCode = countries.find((item) => item.cca3 === countryCode);
    this.setState({
  ...
  componentDidUpdate(previousProps, previousState) {
    if (previousProps.match.params.countryCode !== this.props.match.params.countryCode) {
      this.loadCountryData();
    }
  }
